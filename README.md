...
| :-------------------------------------: | :-------------------------- | :-----------: | :--------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     ![foto](assets/images/christofer.jpeg)            | Costa Morales, Christofer William    | U202315968 | Ingeniería de Software | Estudiante del sexto ciclo de la carrera de Ingeniería de Software de la UPC. Poseo experiencia con los lenguajes de programación: C++, Python, JavaScript, HTML y CSS. En lo personal, me siento capacitado para ayudar y contribuir activamente en el desarrollo técnico de este equipo. Además, de aportar una solución innovadora y accesible para nuestros usuarios                                                                                                                                                                                                                                                                                                                                                                             |
